...
containertype{T<:Diagonal}(::Type{T}) = StructuredArray
containertype{T<:Bidiagonal}(::Type{T}) = StructuredArray
containertype{T<:Tridiagonal}(::Type{T}) = StructuredArray
containertype{T<:SymTridiagonal}(::Type{T}) = StructuredArray
...
@inline broadcast!_c{N}(f, ::Type{AbstractSparseArray}, ::Type{StructuredArray}, C, B, As::Vararg{Any,N}) =
    broadcast!(f, C, _sparsifystructured(B), map(_sparsifystructured, As)...)
@inline broadcast!_c{N}(f, CT::Type, ::Type{StructuredArray}, C, B, As::Vararg{Any,N}) =
    broadcast!_c(f, CT, Array, C, B, As...)
